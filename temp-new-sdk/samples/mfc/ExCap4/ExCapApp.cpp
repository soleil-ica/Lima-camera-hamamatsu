...
//		cmdInfo.m_nShellCommand = CCommandLineInfo::FileNothing;
	...
	pViewMenu->AppendMenu( MF_STRING | MF_POPUP, (UINT)MenuMultiview.GetSafeHmenu(), _T("MultiView Show Image") );
...
void CExCapApp::set_active_objects( HDCAM hdcam,  HDCAMWAIT hwait, CExCapDoc* doc, luttable* lut ) 
{
	 ...
	 || m_active.docForHDCAM != doc )
	{
		...
		m_dlg.framerate->set_hdcamwait( hdcam, hwait, (doc ? doc->get_events() : 0) );
